...
MIDDLEWARE = [
    ...
    # 'common.middleware.access_record.AccessRecordMiddleware',
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'phoenix-web')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
REST_FRAMEWORK = {
    ...
    'DATETIME_FORMAT': DATETIME_STANDARD,
}
...
CELERY_BEAT_SCHEDULE = schedule.CELERY_BEAT_SCHEDULE
