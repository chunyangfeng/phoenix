...
class ProjectInfo(CommonDataModel):
    ...
    project = models.ForeignKey('ProjectInfo', on_delete=models.CASCADE, related_name='sub_project', blank=True,
                                null=True, help_text='自关联，如果关联有外键，则为子项目')
    ...
    status = models.CharField(verbose_name="项目状态", choices=params.PROJECT_STATUS_CHOICE,
...
class ProjectPlanTask(CommonDataModel):
    ...
    status = models.CharField(verbose_name="任务状态", choices=params.TASK_STATUS_CHOICE,
